            ...
            <Col lg={12} xs={24}>
                <Card title={false} className={"animated fadeInRight"}>
                    ...
                    >
                        ...
                        <Form.Item label="User Name" name="username" validateTrigger="onChange" rules={[whiteSpace("Please input your username!")]}>
                            <Input />
                        </Form.Item>
                        ...
                        <Form.Item label="Password" name="password" validateTrigger="onChange" rules={[whiteSpace("Please input your password!")]}>
                            <Input.Password />
                        </Form.Item>
